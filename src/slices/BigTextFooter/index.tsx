...
/**
 * Props for `BigTextFooter`.
 */
export type BigTextFooterProps =
  SliceComponentProps<Content.BigTextFooterSlice>;

/**
 * Component for "BigTextFooter" Slices.
 */
const BigTextFooter: FC<BigTextFooterProps> = ({ slice }) => {
  return (
    <section
