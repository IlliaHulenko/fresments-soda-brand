...
/**
 * Default variation for BigTextFooter Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BigTextFooterSliceDefault = prismic.SharedSliceVariation<
  "default",
  Record<string, never>,
  never
>;
...
/**
 * Slice variation for *BigTextFooter*
 */
type BigTextFooterSliceVariation = BigTextFooterSliceDefault;

/**
 * BigTextFooter Shared Slice
 *
 * - **API ID**: `big_text_footer`
 * - **Description**: BigTextFooter
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type BigTextFooterSlice = prismic.SharedSlice<
  "big_text_footer",
  BigTextFooterSliceVariation
>;
